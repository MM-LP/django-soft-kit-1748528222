...
from newswerve.forms import RegistrationForm, UserLoginForm, UserPasswordResetForm, UserSetPasswordForm, UserPasswordChangeForm
...
def projectsummary(request):
  return render(request, 'pages/01-project-summary.html')

def projectarchitecture(request):
  return render(request, 'pages/02-project-architecture.html')
...
def presentation(request):
  return render(request, 'sections/page sections/presentation.html')
