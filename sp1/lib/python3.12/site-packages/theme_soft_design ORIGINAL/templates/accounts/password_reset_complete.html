...
{% block title %} Metamarine Sport by Creative Tim {% endblock title %}
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
          <div class="card card-plain">
            <div class="card-header pb-0 text-left">
              <h4 class="font-weight-bolder">Password Changed</h4>
            </div>
            <div class="card-body">
              Your password has been changed successfully. Login again.
                  <a class="text-primary" href="{% url 'login' %}">Login</a>
            </div>
          </div>
        </div>
